...
<dl class="leftmenu">
    ...
    <dd>
        ...
        <ul class="menuson">
            <li class="active"><cite></cite><a href="${pageContext.request.contextPath}/admin/jsp/newsInfo/list.jsp" target="rightFrame">新闻管理</a><i></i></li>
            <li><cite></cite><a href="${pageContext.request.contextPath}/admin/jsp/student/list.jsp" target="rightFrame">学生管理</a><i></i></li>
